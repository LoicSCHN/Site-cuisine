@extends('pageUtilisateur')
@section('title','user/ajouter une recette')
@section('userPage')	
	<form method="post" action="{{ url("/pageUtilisateur/ajouterRecette/show") }}">
		...
		<div class="row">
			...
			<div class="d-grid gap-2">
				<input type="submit" name="" class="btn btn-success bouttonEnvoyerRecette" href="{{ url("/pageUtilisateur/ajouterRecette/show") }}">
			</div>
	</form>
